...
Tracking the context that you and the agent have in files.

## Sections ##
1. [What got me interested in this](../3-how-it-started/slide.md)
2. [What it means](../4-what-it-means/slide.md)
3. [Current focus](../5-current-focus/slide.md)
4. [Knowledge](../6-knowledge/slide.md)
5. [Rules](../7-rules/slide.md)
6. [Quick demo](../8-demo/slide.md)
